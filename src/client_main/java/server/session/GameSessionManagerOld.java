package server.session;//package session;
//
...
//    }
//
//    // TODO: shouldn't this be using a json list with integers?
...
//
//    /**
//     * This method is used when a player sends a chat
//     * @param sender the Thread object of the sender Thread of the message
//     * @param content the HashMap that contains the json message
//     */
...
//            }
//        } catch (Exception e) {
//            log("GameSessionManager: Error handling chat message:", e.toString());
//        }
//    }
//}