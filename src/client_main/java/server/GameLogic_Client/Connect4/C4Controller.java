...
public class C4Controller implements IBoardGameController {
    ...
    public void receiveInput(Ivec2 input) {
        ...
        GameLogic_Client.Connect4.C4Piece[][] board = c4GameLogic.getC4Board().getC4Board();
        ...
        if (!c4GameLogic.getC4IsGameOver()) {
            GameLogic_Client.Connect4.C4Piece currentPlayer = c4GameLogic.getC4CurrentPlayer();
     ...
     */
    @Override
    public GameLogic_Client.Connect4.C4Piece[][] getC4Board() {
    ...
    public ArrayList<int[][]> getBoardCells(int LayerMask) {
        ...
        GameLogic_Client.Connect4.C4Piece[][] currentBoardEnum = c4GameLogic.getC4Board().getC4Board();
    ...
    public int getCurrentPlayer() {
        int currentPlayer = 0;
        if (c4GameLogic.getC4CurrentPlayer() == GameLogic_Client.Connect4.C4Piece.BLUE) {
            currentPlayer = 1;
        }
    ...
    public GameLogic_Client.Connect4.C4Piece getC4WinnerAsEnum() {
