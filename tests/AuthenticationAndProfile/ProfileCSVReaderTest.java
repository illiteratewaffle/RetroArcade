...
class ProfileCSVReaderTest {
    ...
    void openSingleProfileFile() {
        ...
        assertEquals(expectedOutput, ProfileCSVReader.openSingleProfileFile("profile_2_exportTest.csv"));
    }

    @Test
    void openProfilesFile() {
        ArrayList<ArrayList<String>> expectedOutput= new ArrayList<>(new ArrayList<>(List.of("1","robert97","Rob","rob@gmail.com",
...
))), new ArrayList<>(List.of("2","sara_b","SaraB","sara@example.com","abcDEF123!@#",
                "Competitive and loves strategy games.","profilePic.png","null","f","4.2","640","gold","157","Connect-4," +
                        " Checkers","{0.60, WinConnect4WithPerfectMoves}","1, 7","4","2025-03-27 05:22:20.752369")));
        assertEquals(expectedOutput, ProfileCSVReader.openProfilesFile("profiles_exportTest.csv"));
    }
}