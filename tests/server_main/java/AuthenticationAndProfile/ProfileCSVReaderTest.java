...
class ProfileCSVReaderTest {
    ...
    void openSingleProfileFile() {
        try {
            ...
            assertEquals(expectedOutput, ProfileCSVReader.openSingleProfileFile("tests/server_main/test_resources/AuthenticationAndProfile/player_profile_1692Test.csv"));
        } catch (IOException e) {
            fail(e.getMessage());
        }
    }
    ...
    void openProfilesFile() {
        try {
            ...
            assertEquals(expectedOutput, ProfileCSVReader.openProfilesFile("tests/server_main/test_resources/AuthenticationAndProfile/profiles_exportTest.csv"));
        } catch (IOException e) {
            fail(e.getMessage());
        }
    }
